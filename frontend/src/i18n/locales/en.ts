...
const en = {
  ...
  questionnaire: {
    ...
    q6a: {
      title: 'Q6a — Sector',
      help:
        'Currently 5 placeholder values; full 14 sectors arrive when sector_overlays.json wiring lands.',
      options: {
        none: '(none)',
        wastewater_biofactories: 'Wastewater / sludge / biofactories',
        agri_food: 'Agri-food / biorefineries',
        process_industry: 'Process industry (chemicals, cement, steel, etc.)',
        other: 'Other (specify)',
      },
    },
