...
const fr: Locale = {
  ...
  questionnaire: {
    ...
    q6a: {
      title: 'Q6a — Secteur',
      help:
        'Actuellement 5 valeurs placeholder ; les 14 secteurs complets arrivent avec le wiring de sector_overlays.json.',
      options: {
        none: '(aucun)',
        wastewater_biofactories: 'Eaux usées / boues / biofactories',
        agri_food: 'Agroalimentaire / bioraffineries',
        process_industry: 'Industrie de process (chimie, ciment, acier, etc.)',
